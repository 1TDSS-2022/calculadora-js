...
//WWindow é o objeto que respresenta a janela do navegador

//Ultizando o getElementById para acessar o elemento HTML
const campo = document.getElementById("txtDisplay")
campo.value = "Olá Mundo!"

//Recuperando a lista de inputs do formulario com getElementsNyTagName
...
//Recuperando o elememto com notação CSS querySelector
const inputs2 = document.querySelectorAll("input")

//Pegando o primeiro input da lista
const primeiroInput3 = inputs2[0]
//Adicionando valor ao elemento recuperado
primeiroInput3.value = "Primeiro com querySelector"
